...
const showParsed = true
const showParsed2 = true
...
func main() {
	...
	if err := tx2.WriteOutput(levin.TxPrm{
		...
		"address":        "85enMysx1tuZVWPRhjU2ibHnaNLwhDrrZMue3viwaFV4HffTn53Vu4F11waowaY5YsJojyWFX7W42811fiPWjPahNsrQqhP",
		//85enMysx1tuZVWPRhjU2ibHnaNLwhDrrZMue3viwaFV4HffTn53Vu4F11waowaY5YsJojyWFX7W42811fiPWjPahNsrQqhP
	}); err != nil {
		fmt.Println("Error:", err)
		os.Exit(4)
	}
	...
	for i, _ := range tx.Outputs {
		noty.NotifyWithLevel(fmt.Sprintf("Tx1_KeyImage: %x", tx.Outputs[i].Target), LevelInfo)
